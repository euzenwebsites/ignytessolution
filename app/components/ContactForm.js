...
const Contactform = () => {
    ...
    <section className=" flex flex-col items-center h-full pt-28 pb-20 relative ">
        <div className="absolute left-0 top-0"><Image src={vector3} alt="vector in red" height={800} width={500}/></div>
    ...
    <div className="text-[#DEE1E6] text-sm">
        ...
        <Link href="mailto:inquiry@ignytestech.com"> <p><span className="inline-flex pr-2"><Image src={mailIcon} alt="mail icon" className="filter-apply"/></span>inquiry@ignytestech.com</p></Link>
